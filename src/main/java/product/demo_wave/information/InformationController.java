...
class InformationController {
	...
	ModelAndView rootByGet(ModelAndView mv, Pageable pageable) {
		InformationGetContext informationGetContext = new InformationGetContext(properties, getUserLogic, mv, pageable);
		return informationService.rootByGet(informationGetContext);
	}
